export const ToggleMode = ({ isActive, onChange }) => {
  ...
  return (
    <label className="relative inline-flex items-center cursor-pointer">
      ...
      />
      <div className="flex items-center justify-center px-1 group peer ring-0 bg-gray3 rounded-full outline-none duration-300 after:duration-300 w-20 h-10 lg:w-25 lg:h-13 shadow-md peer-checked:bg-green1 peer-focus:outline-none after:content-[''] after:rounded-full after:absolute after:bg-green1 after:outline-none after:h-8 after:w-8 lg:after:h-11 lg:after:w-11 after:top-1 after:right-1 lg:after:top-1 lg:after:right-1 after:flex after:justify-center after:items-center peer-checked:after:bg-gray3 peer-checked:after:-translate-x-10 lg:peer-checked:after:-translate-x-12 peer-hover:after:scale-95">
      
      <div className="flex w-8 lg:w-11 items-center justify-center">
        <svg className="left-12 w-5 h-5 lg:w-7 lg:h-7" height="100" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex w-8 lg:w-11 items-center justify-center">
        <svg className="left-12 w-5 h-5 lg:w-7 lg:h-7" height="100" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg">
